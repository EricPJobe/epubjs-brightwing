...
EPUBJS.Book = function(options){
	...
	this.settings = EPUBJS.core.defaults(options || {}, {
		...
		width : undefined,
		height: undefined,
		layoutOverride : undefined, // Default: { spread: 'reflowable', layout: 'auto', orientation: 'auto'}
...
EPUBJS.Book.prototype.useSpreads = function(use) {
	console.warn("useSpreads is deprecated, use forceSingle or set a layoutOverride instead");
	if(use === false) {
...
EPUBJS.Book.prototype.parseLayoutProperties = function(metadata){
	var layout = (this.settings.layoutOverride && this.settings.layoutOverride.layout) || metadata.layout || "reflowable";
	var spread = (this.settings.layoutOverride && this.settings.layoutOverride.spread) || metadata.spread || "auto";
	var orientation = (this.settings.layoutOverride && this.settings.layoutOverride.orientation) || metadata.orientation || "auto";
	return {
		layout : layout,
		spread : spread,
...
EPUBJS.Layout.Fixed.prototype.format = function(documentElement, _width, _height, _gap){
	...
	*/
	...
	//-- Scroll
	documentElement.style.overflow = "scroll";  // was auto
...
EPUBJS.Render.Iframe.prototype.addIframe = function(){
	...
	this.iframe.scrolling = "yes";  //scrolling hardcoded in. Restore this.scrolling || ... for original settings
...
EPUBJS.Render.Iframe.prototype.scroll = function(bool){
	if(bool) {
		...
		//this.scrolling = "yes"; //hardcoded yes
